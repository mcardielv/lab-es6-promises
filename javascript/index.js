...
// getInstruction("mashedPotatoes", 0, step => {step} => { }, (error) => {console.log(error)});
...
async function makeBroccoli() {
  for (let foodItem = 0; foodItem < broccoli.length; foodItem++) {
    await obtainInstruction("broccoli", foodItem)
      .then((step) => {
